...
function diffuseBox(scene) {
    ...
    backgroundMaterial.diffuseTexture = new BABYLON.Texture("assets/textures/reflectivity.png", scene);
...
function importMeshA(scene, x, y, sphere, button1) {
    let item = BABYLON.SceneLoader.ImportMesh("", "assets/models/women/", "Formal.gltf", scene, function (meshes) {
